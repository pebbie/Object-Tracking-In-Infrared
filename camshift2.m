%Meanshift Function 2:
%Created a simple convergence algorithm which looks in windows of varying
%sizes. This function is called by wrapper programs such as single track.
%This algorithm identifes the window size that is most stable. It is
%computationally more intensive than Meanshift Function 1.

function [s_win x_c y_c] = camshift2(I_curr, s_win)
...
for y_f = .5:.1:1.5
    ...
    mins(count,:) = [del x_c y_c x_f y_f]; 
    count = count + 1;
